...
Myquiz = QuizDTO(
    ...
    [
        ...
        QuestionDTO(
            "1-3",
            "Как называется уникальное значение, используемые в веб-приложениях для предотвращения атак с подделкой межсайтовых запросов?",
        ...
        QuestionDTO(
            "1-5",
            "Какие из представленных уровыней изоляции транзакций не существуют?",
